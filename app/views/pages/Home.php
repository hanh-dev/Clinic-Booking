                ...
                <div class="left-banner">
                    <div class="content-banner">
                        <div class="banner-title">
                            <h2>We Help to <span style="color: #0cb8b6">Protect</span> Yourself</h2>
                        </div>
                    ...
                    <div class="widget-container">
                        <div class="widget-wrap">
                            ...
                            <div class="counter-after">Years of Services</div>
                        </div>
                        <div class="widget-wrap">
                            <div class="counter">4k</div>
                            <div class="counter-after">Successful Surgery</div>
                        </div>
                        <div class="widget-wrap">
                            <div class="counter">32k</div>
                            <div class="counter-after">Satisfied Patients</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="hero-banner-3">
                ...
                <div class="banner-3-right">
                    ...
                    <div class="title">
                        <h2>Services <span>That</span> <br> <span>We Provide</span></h2>
                    </div>
                    <div class="description">
                        <p>Comprehensive physical examination, also simply known as
                            a "physical", is a process in which the physician.</p>
                    </div>
            ...
            <div class="hero-banner-5">
                <div class="banner-5-left">
                    ...
                    <div class="content-banner-5">
                        <div class="title">
                            <h2><span>Why</span> Extra Clinic?</h2>
                        </div>
            ...
            <div class="hero-banner-7">
                <div class="banner-7-left">
                    ...
                    <div class="content-banner-7">
                        <div class="title">
                            <h2>Accepted <span>Insurance </span>Providers</h2>
                        </div>
